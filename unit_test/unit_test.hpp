...
public:
    UNIT_TEST()
    {
        REGISTER_TEST(bellman01);
        REGISTER_TEST(bellman02);
        REGISTER_TEST(bellman03);
        REGISTER_TEST(bellman04);
        REGISTER_TEST(bellman05);
        REGISTER_TEST(bellman06);
        REGISTER_TEST(bellman07);
        REGISTER_TEST(bellman08);
        REGISTER_TEST(bellman09);
        REGISTER_TEST(bellman10);
        REGISTER_TEST(bellman11);
        REGISTER_TEST(bellman12);
        REGISTER_TEST(bellman13);
        REGISTER_TEST(bellman14);
        REGISTER_TEST(bellman15);
        REGISTER_TEST(bellman16);
        REGISTER_TEST(bellman17);
        REGISTER_TEST(bellman18);
        REGISTER_TEST(bellman19);
        REGISTER_TEST(bellman20);
    }
